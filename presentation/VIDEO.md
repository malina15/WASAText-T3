# Video Demonstration — MongoDB Execution
...
- Dataset population using a custom script
- Query execution with explain() before indexing
- Index creation on the last_message_at field
- Query execution with explain() after indexing
